export default function Home() {
    return (
        ...
        <div class="min-h-screen bg-gradient-to-r from-black to-gray-800">
                        ...
                        <div
                            ...
                            <div class="lg:py-24">
                                <h1 class="mt-4 text-4xl font-bold tracking-tight text-black sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                    <span class="block text-white">Coming Soon: Illuminate Your World with </span>
                                    <span class="block text-yellow-500">Illumascape NW</span></h1>
                            </div>
                        </div>
                        <img class="object-cover" src="IllumaScape.png" alt=""/>
                    </div>
                </div>
            </div>
        </div>
